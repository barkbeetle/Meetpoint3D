...
<p>
	<img src="doc/example_scenegraph.png" align="right" title="A simple scenegraph"></img>Meetpoint3D organizes it's objects in a scenegraph. This allows you to work with relative transformations. For instance, Player one and two's transformation are relative to the transformation of the floor which again depends on World's transformation. But the camera can be transformed however you want it since it is independent of the World node.
</p>
<div class="title3">Models</div>
<p>
	An important part of every 3D game are models that represent players, enemies or parts of the world you play in. In OpenGL, models consist of vertices (points in the 3-dimensional space) and faces (usually triangles) that connect them. Vertices may contain additional information such as normal vectors or texture coordinates used for materials.<br/>
	For instance a cube is pretty easy to create: You define 8 vertices and six faces (quads) and there you go. A sphere in an acceptable resolution is much more work. And if you work on more complex models, defining all vertices manually is nearly impossible. I therefore created a small plugin for <a href="http://www.maxon.net/">MAXON Cinema 4D</a>, a 3D modelling tool for Macintosh and Windows platforms. It exports all geometry information of your object into a Mojito-XML file (described below). The plugin can be found on GitHub: <a href="http://github.com/barkbeetle/MojitoExporter">github.com/barkbeetle/MojitoExporter</a>
</p>
<div class="title3">The Mojito file format</div>
<p>
	Mojito is a leightweight xml-based file format for static 3D objects. Nodes are organized hierarchically and sotres the following information for each node:
	<ul>
		<li>transformation relative to the parent node</li>
		<li>vertices (position, normal, texcoords)</li>
		<li>faces</li>
		<li>material names (are mapped in materials.xml)</li>
		<li>child nodes</li>
	</ul>
